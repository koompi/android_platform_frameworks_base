...
/**
 * Manages all of the system services that can be returned by
 * {@link Context#getSystemService}. Used by {@link ContextImpl}.
 */
final class SystemServiceRegistry {
    ...
    static {
        ...
        registerService(Context.ACCOUNT_SERVICE, AccountManager.class, new CachedServiceFetcher<AccountManager>() {
            @Override
        ...
        registerService(Context.ALARM_SERVICE, AlarmManager.class, new CachedServiceFetcher<AlarmManager>() {
            @Override
        ...
        registerService(Context.BATTERY_SERVICE, BatteryManager.class, new StaticServiceFetcher<BatteryManager>() {
            ...
            public BatteryManager createService() throws ServiceNotFoundException {
                IBatteryStats stats = IBatteryStats.Stub
                        .asInterface(ServiceManager.getServiceOrThrow(BatteryStats.SERVICE_NAME));
        ...
        registerService(Context.INPUT_SERVICE, InputManager.class, new StaticServiceFetcher<InputManager>() {
            @Override
        ...
        registerService(Context.LOCATION_SERVICE, LocationManager.class, new CachedServiceFetcher<LocationManager>() {
            @Override
        ...
        registerService(Context.NOTIFICATION_SERVICE, NotificationManager.class,
                new CachedServiceFetcher<NotificationManager>() {
                    ...
                    public NotificationManager createService(ContextImpl ctx) {
                        ...
                        return new NotificationManager(new ContextThemeWrapper(outerContext,
                                Resources.selectSystemTheme(0, outerContext.getApplicationInfo().targetSdkVersion,
        ...
        registerService(Context.STORAGE_STATS_SERVICE, StorageStatsManager.class,
                new CachedServiceFetcher<StorageStatsManager>() {
                    ...
                    public StorageStatsManager createService(ContextImpl ctx) throws ServiceNotFoundException {
                        IStorageStatsManager service = IStorageStatsManager.Stub
                                .asInterface(ServiceManager.getServiceOrThrow(Context.STORAGE_STATS_SERVICE));
        ...
        registerService(Context.LOWPAN_SERVICE, LowpanManager.class, new CachedServiceFetcher<LowpanManager>() {
            @Override
                ...
                new CachedServiceFetcher<CompanionDeviceManager>() {
                    ...
                    public CompanionDeviceManager createService(ContextImpl ctx) throws ServiceNotFoundException {
                        ...
                        if (ctx.getPackageManager().hasSystemFeature(PackageManager.FEATURE_COMPANION_DEVICE_SETUP)) {
                            service = ICompanionDeviceManager.Stub
                                    .asInterface(ServiceManager.getServiceOrThrow(Context.COMPANION_DEVICE_SERVICE));
                        }
        ...
        registerService(Context.PERSISTENT_DATA_BLOCK_SERVICE, PersistentDataBlockManager.class,
                new StaticServiceFetcher<PersistentDataBlockManager>() {
                    ...
                    public PersistentDataBlockManager createService() throws ServiceNotFoundException {
                        ...
                        IPersistentDataBlockService persistentDataBlockService = IPersistentDataBlockService.Stub
                                .asInterface(b);
        ...
        registerService(Context.MIDI_SERVICE, MidiManager.class, new CachedServiceFetcher<MidiManager>() {
            @Override
    ...
    /**
     * Statically registers a system service with the context. This method must be
     * called during static initialization only.
     */
    ...
    /**
     * Base interface for classes that fetch services. These objects must only be
     * created during static initialization.
     */
    ...
    /**
     * Override this class when the system service constructor needs a ContextImpl
    ...
    /**
     * Override this class when the system service does not need a ContextImpl and
     * should be cached and retained process-wide.
     */
    ...
    /**
     * Like StaticServiceFetcher, creates only one instance of the service per
     * application, but when creating the service for the first time, passes it the
     * application context of the creating application.
     *
     * TODO: Delete this once its only user (ConnectivityManager) is known to work
     * well in the case where multiple application components each have their own
