...
public final class PerspectiveManager {
    ...
    public void registerPerspectiveListener(final PerspectiveListener listener, final Handler handler) {
        if (listener == null) {
    ...
    /**
     * This class ensures that events are delivered to a listener on its original
     * registering thread or specified alternate Handler.
     */
    private static final class PerspectiveListenerHandler extends Handler {
        private PerspectiveListener mListener;

        public PerspectiveListenerHandler(final PerspectiveListener listener, final Handler handler) {
