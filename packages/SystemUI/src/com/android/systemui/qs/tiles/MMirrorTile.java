...
public class MMirrorTile extends QSTileImpl<BooleanState> {
    ...
    public MMirrorTile(QSHost host) {
        ...
        mDisplayManager = (DisplayManager) host.getContext().getSystemService(Context.DISPLAY_SERVICE);
    ...
    public int getMetricsCategory() {
        return MetricsEvent.QS_MMIRROR_TOGGLE;
    }
    ...
    private class MDisplayListener implements DisplayManager.DisplayListener {
        /**
         * Keep track of public presentation displays. These are displays that will show
         * either PIONUX Desktop or the mirrored phone screen.
         */
        ...
        /**
         * We may miss a display event since listeners are unregistered when the QS
         * panel is hidden.
         *
         * Call this before registering to make sure the initial state is up-to-date.
         */
        public void sync() {
